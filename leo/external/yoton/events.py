# -*- coding: utf-8 -*-
#@+leo-ver=5-thin
#@+node:ekr.20170317181843.1: * @file events.py
#@@first
#@+<< docstring >>
#@+node:ekr.20170317183149.1: ** << docstring >>
""" Module yoton.events
...
#@-<< docstring >>
#@+<< imports >>
#@+node:ekr.20170317181855.1: ** << imports >> events.py
...
#@-<< imports >>
#@+others
#@+node:ekr.20170317181855.2: ** class CallableObject
class CallableObject(object):
    ...
    #@+others
    #@+node:ekr.20170317181855.3: *3* __init__
    def __init__(self, c):
    ...
    #@+node:ekr.20170317181855.4: *3* isdead
    def isdead(self):
    ...
    #@+node:ekr.20170317181855.5: *3* compare
    def compare(self, other):
        ...
        if self._ob and other._ob:
            ...
            return False
    #@+node:ekr.20170317181855.6: *3* __str__
    def __str__(self):
        return self._func.__str__()
    #@+node:ekr.20170317181855.7: *3* call
    def call(self, *args, **kwargs):
        ...
        try:
            ...
            print(getErrorMsg())
    #@-others
#@+node:ekr.20170317181855.8: ** class Event
class Event(object):
    ...
    #@+others
    #@+node:ekr.20170317181855.9: *3* __init__
    ...
    #@+node:ekr.20170317181855.10: *3* dispatch
    def dispatch(self):
        """ dispatch()
    ...
    #@+node:ekr.20170317181855.11: *3* _on_timeout
    ...
    #@-others
#@+node:ekr.20170317181855.12: ** class Signal
class Signal:
    """ Signal()
    ...
    #@+others
    #@+node:ekr.20170317181855.13: *3* __init__
    def __init__(self):
        self._handlers = []

    #@+node:ekr.20170317181855.14: *3* type
    @property
    def type(self):
    ...
    #@+node:ekr.20170317181855.15: *3* bind
    def bind(self, func):
        """ bind(func)
    ...
    #@+node:ekr.20170317181855.16: *3* unbind
    ...
    #@+node:ekr.20170317181855.17: *3* emit
    ...
    #@+node:ekr.20170317181855.18: *3* emit_now
    ...
    #@-others
#@+node:ekr.20170317181855.19: ** class TheTimerThread
class TheTimerThread(threading.Thread):
    ...
    """
    #@+others
    #@+node:ekr.20170317181855.20: *3* __init__
    def __init__(self):
    ...
    #@+node:ekr.20170317181855.21: *3* stop
    ...
    #@+node:ekr.20170317181855.22: *3* add
    def add(self, timer):
        """ add(timer)
    ...
    #@+node:ekr.20170317181855.23: *3* _sort
    def _sort(self):
        self._timers = sorted(self._timers, 
                key=lambda x: x._timeout, reverse=True)

    #@+node:ekr.20170317181855.24: *3* discard
    ...
    #@+node:ekr.20170317181855.25: *3* run
    def run(self):
        self._condition.acquire()
        try:
            self._mainloop()
    ...
    #@+node:ekr.20170317181855.26: *3* _mainloop
    def _mainloop(self):
...
#@+node:ekr.20170317181855.27: ** class Timer
class Timer(Signal):
    ...
    #@+others
    #@+node:ekr.20170317181855.28: *3* __init__
    ...
    #@+node:ekr.20170317181855.29: *3* interval
    @Property
    def interval():
        ...
        return locals()
    #@+node:ekr.20170317181855.30: *3* oneshot
    @Property
    def oneshot():
    ...
    #@+node:ekr.20170317181855.31: *3* running
    @property
    def running(self):
        """ Get whether the timer is running. 
        """
        return self._timeout > 0
    #@+node:ekr.20170317181855.32: *3* start
    ...
    #@+node:ekr.20170317181855.33: *3* stop
    def stop(self):
        """ stop()
        ...
        self._timeout = 0
    #@+node:ekr.20170317181855.34: *3* _on_timeout
    def _on_timeout(self):
        ...
        if self.oneshot:
            ...
            return True
    #@-others
#@+node:ekr.20170317181855.35: ** class YotonApplication
class YotonApplication(object):
    ...
    #@+others
    #@+node:ekr.20170317181855.36: *3* call_later
    ...
    #@+node:ekr.20170317181855.37: *3* post_event
    ...
    #@+node:ekr.20170317181855.38: *3* post_event_asap
    ...
    #@+node:ekr.20170317181855.39: *3* post_event_later
    ...
    #@+node:ekr.20170317181855.40: *3* process_events
    ...
    #@+node:ekr.20170317181855.41: *3* start_event_loop
    ...
    #@+node:ekr.20170317181855.42: *3* stop_event_loop
    ...
    #@+node:ekr.20170317181855.43: *3* embed_event_loop
