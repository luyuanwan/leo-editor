# -*- coding: utf-8 -*-
#@+leo-ver=5-thin
#@+node:ekr.20170317181758.1: * @file context.py
#@@first
...
"""
#@+<< imports >>
#@+node:ekr.20170317181809.1: ** << imports >> context.py
...
#@-<< imports >>
#@+others
#@+node:ekr.20170317181809.2: ** class Context
class Context(object):
    ...
    #@+others
    #@+node:ekr.20170317181809.3: *3* __init__
    ...
    #@+node:ekr.20170317181809.4: *3* close
    def close(self):
        """ close()
    ...
    #@+node:ekr.20170317181809.5: *3* close_channels
    ...
    #@+node:ekr.20170317181809.6: *3* connections_all
    @property
    ...
    #@+node:ekr.20170317181809.7: *3* connections
    @property
    ...
    #@+node:ekr.20170317181809.8: *3* connection_count
    @property
    ...
    #@+node:ekr.20170317181809.9: *3* id
    @property
    def id(self):
    ...
    #@+node:ekr.20170317181809.10: *3* bind
    def bind(self, address, max_tries=1, name=''):
        ...
        return connection
    #@+node:ekr.20170317181809.11: *3* connect
    ...
    #@+node:ekr.20170317181809.12: *3* flush
    ...
    #@+node:ekr.20170317181809.13: *3* _register_sending_channel
    ...
    #@+node:ekr.20170317181809.14: *3* _register_receiving_channel
    ...
    #@+node:ekr.20170317181809.15: *3* _unregister_channel
    ...
    #@+node:ekr.20170317181809.16: *3* _send_package
    ...
    #@+node:ekr.20170317181809.17: *3* _recv_package
    ...
    #@+node:ekr.20170317181809.18: *3* _recv_context_package
