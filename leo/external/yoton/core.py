# -*- coding: utf-8 -*-
#@+leo-ver=5-thin
#@+node:ekr.20170317181823.1: * @file core.py
#@@first
#@+<< imports >>
#@+node:ekr.20170317181832.1: ** << imports >> core.py
...
#@-<< imports >>
#@+others
#@+node:ekr.20170317183106.1: ** Helpers
#@+node:ekr.20170317181832.2: *3* can_send
...
#@+node:ekr.20170317181832.3: *3* can_recv
...
#@+node:ekr.20170317181832.4: *3* send_all
...
#@+node:ekr.20170317181832.5: *3* recv_all
...
#@+node:ekr.20170317181832.6: ** class Package
class Package(object):
    ...
    #@+others
    #@+node:ekr.20170317181832.7: *3* __init__
    ...
    #@+node:ekr.20170317181832.8: *3* parts
    def parts(self):
        """ parts()
